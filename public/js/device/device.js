...
import { buildDisplayBody, refreshInterval, sleepModeFor } from '../core/config.js';
import {
...
import { $, val, toast, fmtBytes, fmtLocalSeconds } from '../core/util.js';
...
export function stopDeviceRuntime() {
  ...
  // Settle anything being awaited, THEN kill the timers: a wait settles itself from
  // inside its own interval, so clearing the interval first strands the promise.
  abortPendingWaits();
